...
import os
import numpy as np
from lib.test.tracker.mixformerpp_vit_online import MixFormerOnline
from pytracking.ARcm_seg import ARcm_seg
from pytracking.vot20_utils import *

import lib.test.parameter.mixformerpp_vit_online as vot_params

class MIXFORMER_ALPHA_SEG(object):
    def __init__(self, tracker,
                 refine_model_name='ARcm_coco_seg_only_mask_384', threshold=0.6):
...
params = vot_params.parameters("baseline_large_score", model="MixFormer-score-ViT-uphead-L-multi-384-ep37.pth.tar")
